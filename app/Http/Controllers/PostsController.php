...
class PostsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('http://localhost:81/laravel/laravel/public/posts')->with('success', 'Post Created');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('http://localhost:81/laravel/laravel/public/posts')->with('success', 'Post Updated');
    }
